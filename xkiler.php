...
$Divar="$url/Divar/?e=$O" ;
$sheypoor="$url/shey/?e=$O" ;
$book="$url/book/?e=$O" ;
$dgkala="$url/dgkala/?e=$O" ;
$mask="$url/mask/?e=$O" ;
$sabadkala="$url/sabadkala/?e=$O" ;
$pubg="$url/pubg/?e=$O" ;
...
║ $book
╠═══════════════╣⫸
╟ ✳️ Name : dgkala (دیجی کالا)
║ $dgkala
╠═══════════════╣⫸
╟ ✳️ Name : mask (ماسک)
║ $mask
╠═══════════════╣⫸
╟ ✳️ Name : sabadkala (سبدکالا)
║ $sabadkala
╠═══════════════╣⫸
╟ ✳️ Name : netstudent (نت دانش آموزی)
║ $netstudent
║
║
╠[𝚈𝚘𝚞𝚛 𝙸𝙿]╣⫸
